...

{
  ...
  # manage.
  home.username = "akash-bhattacharya";
  home.homeDirectory = "/home/akash-bhattacharya";
  ...
  home.packages = with pkgs; [
    ...
    zoxide
    jq
    yq-go              # Note: 'pkgs.yq' is a Python wrapper. 'pkgs.yq-go' is the standard Mike Farah version.
  ...
  # or
  #
  #  /etc/profiles/per-user/akash-bhattacharya/etc/profile.d/hm-session-vars.sh
  #
